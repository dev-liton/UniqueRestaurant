            ...
            if (jQuery(this).hasClass('restbeef_pswp_video_slide')) {
                ...
                if (restbeef_thishref.indexOf('vimeo') + 1) {
                    ...
                    var videoid_split = restbeef_thishref.split('m/'),
                        videoid = videoid_split[1],
                        restbeef_pswp_html = '<div class="restbeef_pswp_video_wrapper"><iframe width="100%" height="100%" src="https://player.vimeo.com/video/' + videoid + '?api=1&amp;title=0&amp;byline=0&amp;portrait=0&autoplay=0&loop=0&controls=1" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></div>';
                    0
                }
                var this_item = {
